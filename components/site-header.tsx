            ...
            <Sheet>
              ...
              <SheetContent side="right" className="liquid-glass border-gray-800 p-0 w-64 flex flex-col">
                ...
                <div className="flex items-center gap-2 px-4 py-4 border-b border-gray-800">
                  <Image src="/icons/jlm-estk-logo.png" alt="JLM ESTK logo" width={36} height={36} className="h-9 w-9" />
                  <span className="font-semibold tracking-wide text-white text-lg">JLM ESTK</span>
                </div>
